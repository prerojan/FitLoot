...
const PHRASE_REPLACEMENTS: ReadonlyArray<readonly [RegExp, string]> = [
  ...
  [/\bBulgarian Split Squat\b/gi, "Agachamento B\u00falgaro"],
  [/\bSplit Squat\b/gi, "Agachamento Dividido"],
  [/\bStep-?up\b/gi, "Subida no Banco"],
  [/\bWalking Lunge\b/gi, "Avan\u00e7o Caminhando"],
  [/\bReverse Lunge\b/gi, "Avan\u00e7o Reverso"],
  [/\bSide Lunge\b/gi, "Avan\u00e7o Lateral"],
  ...
  [/\bDiamond Push-?up\b/gi, "Flex\u00e3o Diamante"],
  [/\bMountain Climber\b/gi, "Escalador"],
  [/\bBodyweight Row\b/gi, "Remada Invertida"],
...
const INSTRUCTION_STEP_PREFIX_REGEX = new RegExp(String.raw`^\s*(?:step|passo)\s*:?\s*\d+\s*(?::|\.|\)|-)?\s*`, "iu");
...
const INSTRUCTION_PHRASE_REPLACEMENTS: ReadonlyArray<readonly [RegExp, string]> = [
  [new RegExp(String.raw`\bStep\s*:?\s*(\d+)\s*(?::|\.|\)|-)?\s*`, "gi"), ""],
  [new RegExp(String.raw`\bStep\s*:?\s+(\d+)\b`, "gi"), ""],
  ...
  [/\bLie flat on your back with your knees bent and feet flat on the ground\b/gi, "Deite-se de costas, com os joelhos flexionados e os p\u00e9s apoiados no ch\u00e3o"],
  [/\bLie flat on your back with your arms extended towards the ceiling\b/gi, "Deite-se de costas, com os bra\u00e7os estendidos em dire\u00e7\u00e3o ao teto"],
  [/\bPlace your hands behind your head with your elbows pointing outwards\b/gi, "Apoie as m\u00e3os atr\u00e1s da cabe\u00e7a, com os cotovelos apontados para fora"],
  [/\bEngaging your abs, slowly lift your upper body off the ground, curling forward until your torso is at a 45-degree angle\b/gi, "Contraia o abd\u00f4men e eleve o tronco devagar, enrolando o corpo at\u00e9 formar cerca de 45 graus"],  [/\bEngage your abs and lift your shoulders off the ground, curling forward towards your knees\b/gi, "Contraia o abd\u00f4men e eleve os ombros do ch\u00e3o, enrolando o tronco em dire\u00e7\u00e3o aos joelhos"],
  [/\bPause for a moment at the top, then slowly lower your upper body back down to the starting position\b/gi, "Faça uma breve pausa no alto e abaixe o tronco devagar at\u00e9 voltar \u00e0 posi\u00e7\u00e3o inicial"],
  [/\bRepeat for the desired number of repetitions\b/gi, "Repita pelo n\u00famero desejado de repeti\u00e7\u00f5es"],
  [/\bStart in a high plank position with your hands slightly wider than shoulder-width apart and your feet together\b/gi, "Comece em posi\u00e7\u00e3o alta de prancha, com as m\u00e3os um pouco al\u00e9m da largura dos ombros e os p\u00e9s juntos"],
  [/\bEngage your core and lower your body towards the ground by bending your elbows, keeping your body in a straight line\b/gi, "Ative o core e abaixe o corpo em dire\u00e7\u00e3o ao ch\u00e3o dobrando os cotovelos, mantendo o corpo em linha reta"],
  [/\bPause for a moment when your chest is just above the ground, then push yourself back up to the starting position by straightening your arms\b/gi, "Faça uma breve pausa quando o peito estiver quase tocando o ch\u00e3o e empurre o corpo de volta \u00e0 posi\u00e7\u00e3o inicial ao estender os bra\u00e7os"],
  [/\bBend your knees and lift your legs off the ground, creating a 90-degree angle at your hips and knees\b/gi, "Flexione os joelhos e eleve as pernas do ch\u00e3o, formando um \u00e2ngulo de 90 graus entre quadris e joelhos"],
  [/\bEngage your core and lower back to press your lower back into the ground\b/gi, "Ative o core e a lombar para manter a regi\u00e3o lombar apoiada no ch\u00e3o"],
  [/\bSlowly lower your right arm and left leg towards the ground, keeping them straight and hovering just above the floor\b/gi, "Abaixe devagar o bra\u00e7o direito e a perna esquerda em dire\u00e7\u00e3o ao ch\u00e3o, mantendo-os estendidos e pr\u00f3ximos do solo"],
  [/\bPause for a moment, then return to the starting position\b/gi, "Faça uma breve pausa e volte \u00e0 posi\u00e7\u00e3o inicial"],
  [/\bRepeat the movement with your left arm and right leg\b/gi, "Repita o movimento com o bra\u00e7o esquerdo e a perna direita"],
  [/\bContinue alternating sides for the desired number of repetitions\b/gi, "Continue alternando os lados pelo n\u00famero desejado de repeti\u00e7\u00f5es"],
  [/Deite-se de costas on your Costas with your bra\u00e7os extended towards the teto/gi, "Deite-se de costas, com os bra\u00e7os estendidos em dire\u00e7\u00e3o ao teto"],
  [/Flexione os joelhos and Eleve os pernas off the ch\u00e3o, creating a 90-degree angle at your quadris and joelhos/gi, "Flexione os joelhos e eleve as pernas do ch\u00e3o, formando um \u00e2ngulo de 90 graus entre quadris e joelhos"],
  [/Ative o core and Lombar to press your Lombar into the ch\u00e3o/gi, "Ative o core e a lombar para manter a regi\u00e3o lombar apoiada no ch\u00e3o"],
  [/Abaixe devagar your right arm and left leg towards the ch\u00e3o, keeping them straight and hovering just above the ch\u00e3o/gi, "Abaixe devagar o bra\u00e7o direito e a perna esquerda em dire\u00e7\u00e3o ao ch\u00e3o, mantendo-os estendidos e pr\u00f3ximos do solo"],
  [/Pause por um instante, depois return to the Posi\u00e7\u00e3o inicial/gi, "Fa\u00e7a uma breve pausa e volte \u00e0 posi\u00e7\u00e3o inicial"],
  [/Repita o movimento with your left arm and right leg/gi, "Repita o movimento com o bra\u00e7o esquerdo e a perna direita"],
  [/Continue alternating sides for the n\u00famero desejado de repeti\u00e7\u00f5es/gi, "Continue alternando os lados pelo n\u00famero desejado de repeti\u00e7\u00f5es"],
  [/Deite-se de costas on your Costas com os joelhos flexionados and p\u00e9s flat no ch\u00e3o/gi, "Deite-se de costas, com os joelhos flexionados e os p\u00e9s apoiados no ch\u00e3o"],
  [/Engaging your Abd\u00f4men, Devagar Eleve os Parte Superior off the ch\u00e3o, curling forward at\u00e9 your torso is at a 45-degree angle/gi, "Contraia o abd\u00f4men e eleve o tronco devagar, enrolando o corpo at\u00e9 formar cerca de 45 graus"],
  [/Pause por um instante at the top, depois Abaixe devagar your Parte Superior Costas down to the Posi\u00e7\u00e3o inicial/gi, "Fa\u00e7a uma breve pausa no alto e abaixe o tronco devagar at\u00e9 voltar \u00e0 posi\u00e7\u00e3o inicial"],
  [/\bStand with your feet shoulder-width apart\b/gi, "Fique em p\u00e9, com os p\u00e9s na largura dos ombros"],
  [/\bTake a step forward with your right leg, lowering your body into a lunge position\b/gi, "D\u00ea um passo \u00e0 frente com a perna direita e abaixe o corpo at\u00e9 a posi\u00e7\u00e3o de avan\u00e7o"],
  [/\bKeep your torso upright and your front knee aligned with your ankle\b/gi, "Mantenha o tronco ereto e o joelho da frente alinhado com o tornozelo"],
  [/\bPush off with your right foot and bring your left foot forward, stepping into a lunge position with your left leg\b/gi, "Empurre o solo com o p\u00e9 direito, traga o p\u00e9 esquerdo \u00e0 frente e entre no avan\u00e7o com a perna esquerda"],
  [/\bContinue alternating legs and walking forward, maintaining a controlled and steady pace\b/gi, "Continue alternando as pernas e caminhando para frente com ritmo controlado e constante"],
  ...
  [/\bSlightly wider than shoulder-width apart\b/gi, "um pouco al\u00e9m da largura dos ombros"],
  ...
  [/\bWith your hands\b/gi, "com as m\u00e3os"],
  [/\bWith your feet\b/gi, "com os p\u00e9s"],
  ...
  [/\bKeep your body in a straight line\b/gi, "Mantenha o corpo em linha reta"],
  ...
  [/\bBy bending your\b/gi, "flexionando os"],
  ...
  [/\bPause for a moment\b/gi, "Pause por um instante"],
  ...
  [/\bPush yourself back up\b/gi, "Empurre o corpo de volta"],
  ...
  [/\bUntil\b/gi, "at\u00e9"],
  [/\bThen\b/gi, "depois"],
  [/\bJust above the floor\b/gi, "logo acima do ch\u00e3o"],
  [/\bDesired number of repetitions\b/gi, "n\u00famero desejado de repeti\u00e7\u00f5es"],
  [/\bDesired number of reps\b/gi, "n\u00famero desejado de repeti\u00e7\u00f5es"],
