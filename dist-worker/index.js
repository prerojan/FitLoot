...
// src/shared/types.ts
var UserProfileSchema = zod_default.object({
  id: zod_default.number(),
  user_id: zod_default.string(),
  username: zod_default.string(),
  full_name: zod_default.string(),
  weight: zod_default.number().nullable(),
  height: zod_default.number().nullable(),
  initial_conditioning: zod_default.string().nullable(),
  injuries: zod_default.string().nullable(),
  equipment: zod_default.string().nullable(),
  main_goal: zod_default.string().nullable(),
  custom_color: zod_default.string().nullable(),
  custom_font: zod_default.string().nullable(),
  custom_border: zod_default.string().nullable(),
  created_at: zod_default.string(),
  updated_at: zod_default.string()
});
var UserAttributesSchema = zod_default.object({
  id: zod_default.number(),
  user_id: zod_default.string(),
  strength: zod_default.number(),
  constitution: zod_default.number(),
  vitality: zod_default.number(),
  dexterity: zod_default.number(),
  focus: zod_default.number(),
  created_at: zod_default.string(),
  updated_at: zod_default.string()
});
var UserProgressionSchema = zod_default.object({
  id: zod_default.number(),
  user_id: zod_default.string(),
  xp: zod_default.number(),
  level: zod_default.number(),
  points: zod_default.number(),
  current_streak: zod_default.number(),
  best_streak: zod_default.number(),
  last_activity_date: zod_default.string().nullable(),
  created_at: zod_default.string(),
  updated_at: zod_default.string()
});
var SkillSchema = zod_default.object({
  id: zod_default.number(),
  name: zod_default.string(),
  category: zod_default.string(),
  difficulty: zod_default.string(),
  description: zod_default.string().nullable(),
  calories_per_rep: zod_default.number(),
  strength_gain: zod_default.number(),
  constitution_gain: zod_default.number(),
  vitality_gain: zod_default.number(),
  dexterity_gain: zod_default.number(),
  focus_gain: zod_default.number(),
  required_level: zod_default.number(),
  prerequisite_skill_id: zod_default.number().nullable(),
  created_at: zod_default.string(),
  updated_at: zod_default.string()
});
var UserSkillSchema = zod_default.object({
  id: zod_default.number(),
  user_id: zod_default.string(),
  skill_id: zod_default.number(),
  total_reps: zod_default.number(),
  total_time: zod_default.number(),
  best_reps: zod_default.number(),
  unlocked_at: zod_default.string(),
  created_at: zod_default.string(),
  updated_at: zod_default.string()
});
var MissionSchema = zod_default.object({
  id: zod_default.number(),
  user_id: zod_default.string(),
  type: zod_default.string(),
  title: zod_default.string(),
  description: zod_default.string().nullable(),
  skill_id: zod_default.number().nullable(),
  target_reps: zod_default.number().nullable(),
  target_time: zod_default.number().nullable(),
  xp_reward: zod_default.number(),
  points_reward: zod_default.number(),
  deadline: zod_default.string().nullable(),
  is_completed: zod_default.number(),
  completed_at: zod_default.string().nullable(),
  verified_by_sensor: zod_default.number(),
  created_at: zod_default.string(),
  updated_at: zod_default.string()
});
var AchievementSchema = zod_default.object({
  id: zod_default.number(),
  name: zod_default.string(),
  description: zod_default.string().nullable(),
  rarity: zod_default.string(),
  icon: zod_default.string().nullable(),
  requirement_type: zod_default.string(),
  requirement_value: zod_default.number().nullable(),
  created_at: zod_default.string(),
  updated_at: zod_default.string()
});
var TitleSchema = zod_default.object({
  id: zod_default.number(),
  name: zod_default.string(),
  rarity: zod_default.string(),
  requirement_type: zod_default.string(),
...
var ShopProductSchema = zod_default.object({
  id: zod_default.number(),
  partner_id: zod_default.number(),
  name: zod_default.string(),
  description: zod_default.string().nullable(),
  points_cost: zod_default.number(),
  category: zod_default.string(),
  image_url: zod_default.string().nullable(),
  is_available: zod_default.number(),
  created_at: zod_default.string(),
  updated_at: zod_default.string()
});
var DailyMetricsSchema = zod_default.object({
  id: zod_default.number(),
  user_id: zod_default.string(),
  date: zod_default.string(),
  steps: zod_default.number(),
  calories_burned: zod_default.number(),
  created_at: zod_default.string(),
  updated_at: zod_default.string()
});
var OnboardingRequestSchema = zod_default.object({
  username: zod_default.string().min(3).max(20),
  full_name: zod_default.string().min(1),
  weight: zod_default.number().positive(),
  height: zod_default.number().positive(),
  initial_conditioning: zod_default.enum(["sedentario", "iniciante", "intermediario", "avancado"]),
  initial_pushups: zod_default.number().min(0),
  initial_situps: zod_default.number().min(0),
  initial_squats: zod_default.number().min(0),
  injuries: zod_default.string().optional(),
  equipment: zod_default.string().optional(),
  main_goal: zod_default.enum(["perder_peso", "ganhar_massa", "resistencia", "calistenia", "saude_geral"])
});
var CompleteMissionRequestSchema = zod_default.object({
  mission_id: zod_default.number(),
  reps_completed: zod_default.number().min(0).optional(),
  time_completed: zod_default.number().min(0).optional(),
  sensor_verified: zod_default.boolean()
});
var FoodScanRequestSchema = zod_default.object({
  food_name: zod_default.string(),
  calories: zod_default.number().optional(),
  meal_type: zod_default.enum(["cafe", "almoco", "jantar", "lanche"]).optional()
});
var UpdateDailyMetricsRequestSchema = zod_default.object({
  steps: zod_default.number().min(0),
  calories_burned: zod_default.number().min(0)
});
var FriendRequestSchema = zod_default.object({
  friend_user_id: zod_default.string()
});
var MiniGameChallengeRequestSchema = zod_default.object({
  challenged_user_id: zod_default.string().nullable(),
  skill_id: zod_default.number(),
  target_reps: zod_default.number().min(1),
  opponent_type: zod_default.enum(["friend", "random"])
});
var MiniGameCompleteRequestSchema = zod_default.object({
  reps_completed: zod_default.number().min(0),
  time_seconds: zod_default.number().min(0)
});
var AiChatRequestSchema = zod_default.object({
  message: zod_default.string().min(1),
  history: zod_default.array(zod_default.object({ role: zod_default.string(), content: zod_default.string() })).optional()
});
var AiAnalyzeFoodRequestSchema = zod_default.object({
  food_description: zod_default.string().optional(),
  image_base64: zod_default.string().optional()
}).refine((data) => data.food_description !== void 0 || data.image_base64 !== void 0, {
  message: "Food description or image required"
});
var AuthRegisterRequestSchema = zod_default.object({
  name: zod_default.string().min(1),
  email: zod_default.string().email(),
  password: zod_default.string().min(8)
});
var LoginRequestSchema = zod_default.object({
  email: zod_default.string().email(),
...
var UpdateMeRequestSchema = zod_default.object({
  ...
  photo_url: zod_default.union([zod_default.string().url(), zod_default.literal("")]).optional(),
  goals: zod_default.string().optional(),
  fitness_level: zod_default.string().optional()
});
...
__name(generateCookie, "generateCookie");
...
app.post(
  ...
  async (c) => {
    try {
      ...
      const existing = await c.env.fitloot_db.prepare("SELECT id FROM users WHERE email = ?").bind(data.email).first();
      if (existing) {
        return c.json({ error: "E-mail j\xE1 cadastrado" }, 409);
      }
      ...
      ).bind(userId, data.email, data.name ?? "", passwordHash, salt).run();
      return c.json({ success: true }, 201);
    } catch (error3) {
      console.error("[register]", error3);
      return c.json(
        { error: "Erro interno ao criar usu\xE1rio", code: "INTERNAL_ERROR" },
        500
      );
    }
  }
...
app.post(
  ...
  async (c) => {
    const data = c.req.valid("json");
    const userRow = await c.env.fitloot_db.prepare(
...
app.patch(
  ...
  async (c) => {
    ...
    const data = c.req.valid("json");
    if (data.name !== void 0) {
      await c.env.fitloot_db.prepare("UPDATE users SET name = ? WHERE id = ?").bind(data.name, user.id).run();
    }
    if (data.photo_url !== void 0) {
      await c.env.fitloot_db.prepare("UPDATE users SET avatar_url = ? WHERE id = ?").bind(data.photo_url || null, user.id).run();
    }
    const updated = await c.env.fitloot_db.prepare("SELECT id, email, name, avatar_url FROM users WHERE id = ?").bind(user.id).first();
...
app.post(
  ...
  async (c) => {
    ...
    if (!user) return c.json({ error: "Unauthorized" }, 401);
    const data = c.req.valid("json");
    await c.env.fitloot_db.prepare("UPDATE users SET plan_id = ?, plan_status = ? WHERE id = ?").bind(data.plan_id, data.status, user.id).run();
    const updated = await c.env.fitloot_db.prepare("SELECT id, email, name, avatar_url FROM users WHERE id = ?").bind(user.id).first();
    return c.json(updated ?? c.get("user"));
  }
);
app.get("/api/logout", async (c) => {
  const sessionId = c.req.header("Cookie")?.match(/session_id=([^;]+)/)?.[1];
  if (sessionId) {
    await c.env.fitloot_db.prepare("DELETE FROM sessions WHERE id = ?").bind(sessionId).run();
  }
  c.header(
    "Set-Cookie",
...
app.get("/api/profile", authMiddleware, async (c) => {
  const user = c.get("user");
  if (!user) return c.json({ error: "Unauthorized" }, 401);
  const profile3 = await c.env.fitloot_db.prepare(
  ...
  if (mission.skill_id && data.reps_completed) {
    ...
    if (skill) {
      await c.env.fitloot_db.prepare(
        ...
        skill.strength_gain,
        skill.constitution_gain,
        skill.vitality_gain,
        skill.dexterity_gain,
        skill.focus_gain,
        user.id
      ).run();
    }
...
app.post("/api/mini-games/challenge", authMiddleware, zValidator("json", MiniGameChallengeRequestSchema), async (c) => {
  ...
  if (data.opponent_type === "random") {
    ...
    challengedUserId = randomUser.user_id;
  }
  if (!challengedUserId) {
  ...
  const deadline = new Date(Date.now() + 24 * 60 * 60 * 1e3).toISOString();
  await c.env.fitloot_db.prepare(
...
async function createDailyMissions(db, userId) {
  ...
  for (const skillId of randomSkills) {
    ...
    if (skill) {
      await db.prepare(
        ...
        `Execute ${20} repeti\xE7\xF5es de ${skill.name}`,
        skillId,
        20,
        50,
        10,
...
__name(createDailyMissions, "createDailyMissions");
app.post("/api/ai/generate-missions", authMiddleware, async (c) => {
  ...
  try {
    const [profile3, progression, attributes, skills] = await Promise.all([
    ...
    const prompt = `Voc\xEA \xE9 um personal trainer virtual especializado em gamifica\xE7\xE3o fitness. 

Perfil do usu\xE1rio:
- Nome: ${profile3?.full_name}
- N\xEDvel: ${progression?.level}
- Objetivo: ${profile3?.main_goal}
- Condicionamento: ${profile3?.initial_conditioning}
- Equipamentos: ${profile3?.equipment || "nenhum"}
- Les\xF5es: ${profile3?.injuries || "nenhuma"}

Atributos atuais:
- For\xE7a: ${attributes?.strength}
- Constitui\xE7\xE3o: ${attributes?.constitution}
- Vitalidade: ${attributes?.vitality}
- Destreza: ${attributes?.dexterity}
- Foco: ${attributes?.focus}

Skills desbloqueadas: ${skills.results.map((s) => s.name).join(", ")}

Crie 5 miss\xF5es di\xE1rias DESAFIADORAS mas ALCAN\xC7\xC1VEIS para este usu\xE1rio. As miss\xF5es devem:
1. Ser progressivas e adequadas ao n\xEDvel atual
2. Variar entre diferentes tipos de exerc\xEDcio
3. Considerar os equipamentos dispon\xEDveis
4. Evitar \xE1reas com les\xF5es
  ...
  "missions": [
    {
      ...
      "description": "descri\xE7\xE3o motivadora",
      "skill_name": "nome da skill",
      "target_reps": n\xFAmero,
      "xp_reward": n\xFAmero,
      "points_reward": n\xFAmero,
    ...
    for (const mission of missionsData.missions) {
      const skill = skills.results.find(
        (s) => s.name.toLowerCase().includes(mission.skill_name.toLowerCase())
      );
      await c.env.fitloot_db.prepare(`
        INSERT INTO missions (user_id, type, title, description, skill_id, target_reps, xp_reward, points_reward, deadline, updated_at)
        VALUES (?, 'daily', ?, ?, ?, ?, ?, ?, ?, datetime('now'))
    ...
    return c.json({
      ...
      message: "Miss\xF5es geradas com IA!"
    });
  } catch (error3) {
    console.error("AI generation error:", error3);
...
app.post("/api/ai/chat", authMiddleware, async (c) => {
  ...
  try {
    ...
    const parsed = AiChatRequestSchema.safeParse(raw2);
    if (!parsed.success) {
      return c.json({ error: "Invalid input", details: parsed.error.flatten() }, 400);
    }
    const { message: userMessage, history: conversationHistory = [] } = parsed.data;
    const [profile3, progression, attributes] = await Promise.all([
      c.env.fitloot_db.prepare("SELECT * FROM user_profiles WHERE user_id = ?").bind(user.id).first(),
      c.env.fitloot_db.prepare("SELECT * FROM user_progression WHERE user_id = ?").bind(user.id).first(),
      c.env.fitloot_db.prepare("SELECT * FROM user_attributes WHERE user_id = ?").bind(user.id).first()
    ]);
    const systemPrompt = `Voc\xEA \xE9 o FitBot, um assistente fitness virtual motivador e especializado em gamifica\xE7\xE3o. 
...
2. Forne\xE7a dicas pr\xE1ticas de treino
3. Responda d\xFAvidas sobre exerc\xEDcios
4. Ajude o usu\xE1rio a atingir suas metas
5. Seja conciso (m\xE1ximo 3 par\xE1grafos)
6. Use emojis relevantes \u{1F4AA}\u{1F525}\u26A1

Responda em portugu\xEAs brasileiro de forma amig\xE1vel e motivadora!`;
    const messages = [
      ...conversationHistory,
    ...
    console.error("Chatbot error:", error3);
...
app.get("/api/ai/recommendations", authMiddleware, async (c) => {
  ...
  if (!c.env.ANTHROPIC_API_KEY) return c.json({ error: "AI not configured" }, 503);
  try {
    const [profile3, progression, attributes, skills, completedMissions] = await Promise.all([
      c.env.fitloot_db.prepare("SELECT * FROM user_profiles WHERE user_id = ?").bind(user.id).first(),
      c.env.fitloot_db.prepare("SELECT * FROM user_progression WHERE user_id = ?").bind(user.id).first(),
      c.env.fitloot_db.prepare("SELECT * FROM user_attributes WHERE user_id = ?").bind(user.id).first(),
      c.env.fitloot_db.prepare(`
    ...
    const prompt = `Analise este perfil fitness gamificado e gere recomenda\xE7\xF5es personalizadas.

DADOS DO USU\xC1RIO:
N\xEDvel: ${progression?.level}
XP Total: ${progression?.xp}
Miss\xF5es Completas: ${completedMissions?.count}
...
SKILLS MAIS USADAS:
${skills.results.slice(0, 5).map((s) => `${s.name}: ${s.total_reps} reps`).join("\n")}

Analise e responda APENAS com JSON:
{
  "next_skill_recommendation": {
    "name": "nome da skill",
    "reason": "por que o usu\xE1rio deve focar nisso"
  },
  "weak_attribute": {
  ...
  "motivation_message": "mensagem motivadora personalizada"
    ...
    console.error("Recommendations error:", error3);
...
app.post("/api/ai/analyze-food", authMiddleware, async (c) => {
  ...
  try {
    const raw2 = await c.req.json();
    const parsed = AiAnalyzeFoodRequestSchema.safeParse(raw2);
    if (!parsed.success) {
      return c.json({ error: "Invalid input", details: parsed.error.flatten() }, 400);
    }
      ...
      prompt = `Analise esta imagem de comida e retorne APENAS um JSON com:
{
  ...
  "calories": n\xFAmero estimado de calorias,
  "protein": gramas de prote\xEDna,
  "carbs": gramas de carboidratos,
  "fats": gramas de gordura,
  "healthy_score": n\xFAmero de 1-10,
  "suggestions": "sugest\xF5es para tornar mais saud\xE1vel"
}`;
      messages = [{
        role: "user",
        content: [
...
Retorne APENAS um JSON com:
{
  ...
  "fats": gramas de gordura,
  "healthy_score": n\xFAmero de 1-10,
  "suggestions": "sugest\xF5es para tornar mais saud\xE1vel ou alternativas"
}`;
      messages = [{ role: "user", content: prompt }];
    }
    const aiResponse = await fetch("https://api.anthropic.com/v1/messages", {
    ...
    console.error("Food analysis error:", error3);
...
app.get("/api/ai/workout-suggestions", authMiddleware, async (c) => {
  ...
  if (!c.env.ANTHROPIC_API_KEY) return c.json({ error: "AI not configured" }, 503);
  try {
    const [profile3, progression, metrics] = await Promise.all([
      c.env.fitloot_db.prepare("SELECT * FROM user_profiles WHERE user_id = ?").bind(user.id).first(),
      c.env.fitloot_db.prepare("SELECT * FROM user_progression WHERE user_id = ?").bind(user.id).first(),
      c.env.fitloot_db.prepare(`
        SELECT * FROM daily_metrics 
        WHERE user_id = ? AND date = ?
      `).bind(user.id, (/* @__PURE__ */ new Date()).toISOString().split("T")[0]).first()
    ]);
    const prompt = `Baseado nestes dados de hoje, sugira um treino:

Usu\xE1rio: N\xEDvel ${progression?.level}
Objetivo: ${profile3?.main_goal}
...
Responda APENAS com JSON:
{
  ...
  "duration_minutes": n\xFAmero,
  "intensity": "low|medium|high",
  "exercises": ["exerc\xEDcio 1", "exerc\xEDcio 2", "exerc\xEDcio 3"],
  "motivation": "mensagem motivadora"
    ...
    console.error("Workout suggestions error:", error3);
